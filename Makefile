...
CSRC = $(STARTUPSRC) \
       ...
       FatFs/ffunicode.c \
       usbcfg.c \
       main.c si5351.c tlv320aic3204.c dsp.c plot.c ui.c ili9341.c numfont20x22.c Font5x7.c Font6x10.c Font7x11b.c Font10x14.c data_storage.c hardware.c vna_math.c
